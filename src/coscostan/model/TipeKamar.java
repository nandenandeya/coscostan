...
public class TipeKamar {
    ...
    public TipeKamar(String ukuran, String fasilitasKamar, String tipeKamar, double hargaSewa, String lamaSewa) {
        this.ukuran = ukuran;
    ...
    public String toString() {
        return "TipeKamar{" + "idTipeKamar=" + idTipeKamar + ", ukuran=" + ukuran + 
               ", tipeKamar=" + tipeKamar + ", hargaSewa=" + hargaSewa + 
               ", lamaSewa=" + lamaSewa + '}';
    }
}